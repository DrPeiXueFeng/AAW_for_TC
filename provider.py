...
# 归一化batch data, 使用以centroid为中心的块的坐标
...
def shuffle_data(data, labels):
    ...
    """
    # arrangechuangjian等差数列，0~最大值，也就是labels编号
